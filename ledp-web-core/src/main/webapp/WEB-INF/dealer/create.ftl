...
<#macro content>
	...
	<div class="floatL detaillist">
		<form id="form_dealer_create" class="validateCheck" action="${rc.contextPath}/dealer/save" method="post" data-options="novalidate:true">
			<#include "/dealer/_form.ftl"/>
			<div class="btnsumbit">
				<a href="javascript:void(0)" class="easyui-linkbutton btnstyle" onclick="$('#form_dealer_create').submit();">添 加</a>
