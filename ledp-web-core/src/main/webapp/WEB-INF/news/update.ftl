...
<div class="detaillist ollright">
	<div class="floatL detaillist">
		<form id="form_news_create" action="${rc.contextPath}/news/edit" method="post" data-options="novalidate:true" class="validateCheck formlist">
			...
			<div class="btnsumbit" style="margin:20px 0 0 305px;">
				<@check permissionCodes = permissions permissionCode="news/create">
					...
					<a href="javascript:void(0)" class="easyui-linkbutton btnstyle" id="new_add" >保 存</a>
				</@check>
