...
<#macro content>
	...
	<div class="floatL detaillist">
		<form id="form_organization_create" action="${rc.contextPath}/organization/save" method="post" data-options="novalidate:true" class="validateCheck">
			<#include "/organization/_form.ftl"/>
			<div class="btnsumbit">
				<a href="javascript:void(0)" class="easyui-linkbutton btnstyle" onClick="$('#form_organization_create').submit();">添 加</a>
