...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		<li>
			...
			<span>&gt;&gt;</span>
			<span><a href="${rc.contextPath}/wechat/campaign/update/${campaign.id}">填写活动基本信息</a></span>
			<span>&gt;&gt;</span>
			<span>选择模板</span>
		</li>
	</ul>
	...
	<div class="tabContianer_con displayBlock tabSendpage" >
		<div style="display: block;" class="padding20" id="page_icon1">
			...
			<div class="buttons">
				...
				<input type="button" class="redButton" onclick="window.location.href='${rc.contextPath}/wechat/campaign/update/${campaign.id}'" value="返回">
			</div>
		</div>
		<div id="page_icon2" class="padding20">
			...
			<div class="buttons">
				<a href="javascript:void(0);" onclick="submitForm();" class="redButton" style="color: #fff;" >保 存</a>
				<input type="button" class="redButton" onclick="window.location.href='${rc.contextPath}/wechat/campaign/update/${campaign.id}'" value="返回">
			</div>
		</div>
	</div>
</div>
<form id="cpytTemplate" class="validateCheck" action="${rc.contextPath}/wechat/campaign/copy" method="post">
