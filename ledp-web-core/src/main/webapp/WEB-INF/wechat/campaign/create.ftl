...
<div class="breadcrumbs" id="breadcrumbs">
	...
	<ul class="breadcrumb">
		<li>
			...
			<span>营销应用</span>
			<span>&gt;&gt;</span>
			<span><a href="${rc.contextPath}/wechat/site/index">活动管理</a></span>
			<span>&gt;&gt;</span>
			<span>填写活动基本信息</span>
		</li>
	</ul>
...
<form id="form_camp_save" class="validateCheck" action="${rc.contextPath}/wechat/campaign/save" method="post" enctype="multipart/form-data">
<div class="createActiveFrom">
	<ul class="creatlist">
		<li>
			<label>活动名称：</label>
			<div>
				<input type="text" name="name" style="width: 300px;" maxlength="60" dataType="*" errormsg="请填写活动名称"  nullmsg="请填写活动名称"/>
				<div class="Validform_checktip"></div>
				<span style="margin-top:10px; display:block;">最长为60个字符</span>
			</div>
		</li>
		<li>
			<label>活动时间：</label>
			<div>
				<div id="beginDate" style="width: 200px;" class="floatL" params="{name:'beginDate',id:'cbeginDate',value:'',validate : 'validate' ,dataType:'*',errormsg:'请选择活动开始时间', nullmsg:'请选择活动开始时间'}" ></div>
				<span class="floatL margin10">-</span>
				<div id="endDate" style="width: 200px;" class="floatL" params="{name:'endDate',id:'cendDate',value:'',validate : 'validate' ,dataType:'*',errormsg:'请选择活动结束时间', nullmsg:'请选择活动结束时间'}"></div>
			</div>
		</li>
		<li>
			<label style="font-size:12px;">活动缩略图：</label>
			<div>
				<input id="imageup" type="file" name="image" dataType="*" errormsg="请选择活动缩略图"  nullmsg="请选择活动缩略图"/>
				<div class="Validform_checktip"></div>
			</div>
		</li>
		<li>
		...
		<li>
			<label>活动简介：</label>
			<div>
				<textarea class="textarea" name="comment" maxlength="200" dataType="*" errormsg="请填写活动说明"  nullmsg="请填写活动说明"></textarea>
				<div class="Validform_checktip"></div>
				<span style="margin-top:10px; display:block;">最长为200个字符</span>
			</div>
		</li>
	</ul>
