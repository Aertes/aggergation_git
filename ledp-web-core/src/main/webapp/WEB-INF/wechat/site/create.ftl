...
<form id="form_camp_save" class="validateCheck" action="${rc.contextPath}/wechat/site/save" method="post" enctype="multipart/form-data">
<div class="createActiveFrom">
		<ul class="creatlist">
			<li>
				<label>微站名称：</label>
				<div>
					<input type="text" name="name" style="width: 300px;" maxlength="60" dataType="*" errormsg="请填写名称"  nullmsg="请填写名称"/>
			...
			<li>
				...
				<div>
					<input style="line-height:30px;" id="imageup" type="file" name="image" dataType="*" errormsg="请选择缩略图"  nullmsg="请选择缩略图"/>
					<div class="Validform_checktip"></div>
				</div>
			</li>
			<li>
				...
				<div>
					...
					<span class="floatL marginLeft10 colorR tdSize" style="color:red;">建议图片大小200*200</span>
				</div>
			</li>
			<li>
				<label>微站简介：</label>
				<div>
					<textarea class="textarea" name="bak2" maxlength="200" dataType="*" errormsg="请填写说明"  nullmsg="请填写说明"></textarea>
					<div class="Validform_checktip"></div>
