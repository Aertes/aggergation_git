...
},beforePageText:"共",afterPageText:"{pages}页",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"pagination-first",handler:function(){
...
var temp = Number(s2);
var v=s1+(temp+opts.increment*(down?-1:1))+s3;
...
var _908=$("<input type=\"hidden\" class=\"textbox-value key search\">").appendTo(_906);
_908.attr("name",name);
if(opts.disabled){
...
_9c0(this,q);
}},currentText:"今天",closeText:"清空",okText:"确认",buttons:[{text:function(_9d5){
