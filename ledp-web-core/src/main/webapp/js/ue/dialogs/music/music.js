...
(function () {
    ...
    function insertUpload(){
        var videoObjs=[],
            uploadDir = editor.getOpt('videoUrlPrefix'),list="<p>";
/*            width = $G('upload_width').value || 420,
        ...
        for(var key in uploadVideoList) {
            ...
            list = list+ '<img align="none" width="400" height="95" _url="'+uploadDir + file.url+'" class="edui-faked-music" src="'+s+'/lang/zh-cn/images/music.png" _src="'+s+'/lang/zh-cn/images/music.png">';
        }
        list=list+"</p>"
        editor.execCommand('insertHtml', list);
        ...
        setList: function (list) {
            ...
            if(list.length) {
                for (i = 0; i < list.length; i++) {
                    ...
                    img.setAttribute('src', 'images/mp3.png');
        ...
        getInsertList: function () {
            ...
            for(var i = 0; i < items.length; i++) {
                ...
                if(child.tagName && child.tagName.toLowerCase() == 'img' && domUtils.hasClass(items[i], 'selected')) {
                    ...
                    title= child.title;
                    var s=window.parent.ueditURL;
                    list = list+ '<img align="none" width="400" height="95" _url="'+src+'" class="edui-faked-music" src="'+s+'/lang/zh-cn/images/music.png" _src="'+s+'/lang/zh-cn/images/music.png">';
...
(function(){
	...
	Music.prototype = {
	        ...
	        _buildMusicHtml:function (playerUrl) {
	        	...
	        	var html = '<audio src="'+playerUrl+'" controls="controls"></audio>'
	            return html;
	        },
