        ...
        getInsertList: function () {
            ...
            for(var i = 0; i < items.length; i++) {
                ...
                if(child.tagName && child.tagName.toLowerCase() == 'img' && domUtils.hasClass(items[i], 'selected')) {
                    ...
                    list = list+ '<img width="420" height="280" _url="'+src+'" class="edui-upload-video  vjs-default-skin" src="'+s+'/themes/default/images/spacer.gif" style="background:url('+s+'/themes/default/images/videologo.gif) no-repeat center center; border:1px solid gray;">'
